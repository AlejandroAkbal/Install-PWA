...
<main class="via-base-0 bg-gradient-to-b from-base-100">
	<div class="pt-2 sm:pt-16 lg:overflow-hidden lg:pb-14 lg:pt-8">
							...
							>
								<div class="sm:flex">
									...
									<div class="mt-3 sm:ml-3 sm:mt-0">
										<button
											class="block w-full rounded-md bg-gradient-to-r from-primary to-secondary px-4 py-3 font-medium text-primary-content shadow hover:brightness-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary-content"
											type="submit"
										>
											Create install page
										</button>
